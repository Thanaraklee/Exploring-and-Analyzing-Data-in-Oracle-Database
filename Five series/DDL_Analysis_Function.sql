-- ลบค่าสำหรับสิ่งที่สั่งให้ให้ตาราง JOB_HISTORY ลบข้อจำกัดของสิ่งที่เกี่ยวข้องกับตาราง EMPLOYEES
...
-- ลบค่าสำหรับสิ่งที่สั่งให้ให้ตาราง DEPARTMENTS ลบข้อจำกัดของสิ่งที่เกี่ยวข้องกับตาราง JOBS
...
-- ลบอินเด็กซ์ที่เกี่ยวข้องกับตาราง REGIONS, COUNTRIES, LOCATIONS, DEPARTMENTS, JOBS, EMPLOYEES, JOB_HISTORY
